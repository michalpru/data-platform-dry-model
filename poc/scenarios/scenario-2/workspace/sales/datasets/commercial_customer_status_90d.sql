-- Sales-owned, enterprise-certified commercial-activity classification (Databricks / Spark SQL).
-- Grain: customer_id x reporting_date. Exposes the authoritative is_active_commercial_90d flag.
-- Physical binding: sales.datasets.commercial_customer_status_90d (Databricks).
