...
Reusable executive reporting metric for **Average Revenue per Active Customer (ARPAC)** over the trailing 90 days. Built using only files under `poc/scenarios/scenario-1a/workspace`.
