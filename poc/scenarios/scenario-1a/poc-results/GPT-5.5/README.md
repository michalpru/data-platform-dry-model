...
This deliverable defines a reusable executive reporting metric for trailing-90-day Average Revenue per Active Customer (ARPAC), using only files under `poc/scenarios/scenario-1a/workspace`.
